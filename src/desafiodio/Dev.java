...
public class Dev {
    ...
    public void progredir(){
        ...
        if( conteudo.isPresent() ){
            this.conteudosConcluidos.add(conteudo.get());           //verificar
            this.conteudosInscritos.remove(conteudo.get());         //verificar   
        }else{
    ...
    public int hashCode() {
        ...
        hash = 83 * hash + Objects.hashCode(this.conteudosInscritos);
        hash = 83 * hash + Objects.hashCode(this.conteudosConcluidos);
        return hash;
    }
